...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hepstorefront/electronics/en",
						"https://electronics.local:9002/hepstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hepstorefront/electronics/en",
						"https://electronics.local:9002/hepstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hepstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/hepstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hepstorefront/electronics/en",
						"https://electronics.local:9002/hepstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hepstorefront",
						"https://electronics.local:9002/hepstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hepstorefront",
						"https://electronics.local:9002/hepstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/hepstorefront/electronics/en",
						"https://electronics.local:9002/hepstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
