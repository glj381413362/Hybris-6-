...
<c:choose>
	<c:when test="${wro4jEnabled}">
	  	<script type="text/javascript" src="${contextPath}/wro/part1_mobile.js"></script>
		...
		<script type="text/javascript" src="${contextPath}/wro/part2_mobile.js"></script>
		<script type="text/javascript">
			$(function() {
		...
		<script type="text/javascript" src="${contextPath}/wro/part3_mobile.js"></script>
		
		<script type="text/javascript" src="${contextPath}/wro/addons_mobile.js"></script>
	</c:when>
	<c:otherwise>
		<%-- jQuery --%>
