...
<div class="js-cart-totals row">
	...
	<c:if test="${cartData.quoteDiscounts.value > 0}">
		<div class="col-xs-6 cart-totals-left discount"><spring:theme code="basket.page.quote.discounts" /></div>
		<div class="col-xs-6 cart-totals-right text-right discount">
			<ycommerce:testId code="Quote_Totals_Savings"><format:price priceData="${cartData.quoteDiscounts}" /></ycommerce:testId>
		</div>
	</c:if>

    <c:if test="${cartData.totalDiscounts.value > 0}">
        <div class="col-xs-6 cart-totals-left discount"><spring:theme code="basket.page.totals.discounts"/></div>
        <div class="col-xs-6 cart-totals-right text-right discount">
