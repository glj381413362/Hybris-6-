 ...
 */
package com.hep.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(HepFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(HepFulfilmentProcessConstants.PARENT_PROCESS);
